...
const AcademicProjectCard: React.FC<{ project: any }> = ({ project }) => {
  ...
  return (
    <div
      className="relative bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300 max-w-full mx-auto flex flex-col justify-between"
